...
<p style="text-align: justify"> <font size="-1"> <strong> Abstract: </strong> The primary goal of Short-Time Work (STW) programs is to protect jobs and firms. However, their cost-effectiveness during the pandemic remains insufficiently understood from a causal perspective. This paper examines the effectiveness of STW during the COVID-19 pandemic, characterized by widespread economic closures and unprecedented uptake rates. Employing a regression discontinuity design, I exploit a unique policy change in Belgium that restricted STW simplified access for firms that did not take up the program for at least 20% of total contractual days at the crisis peak. The findings reveal that workers ineligible (eligible) for the simplified program within firms that had some of the most-affected joint committees of workers experienced statistically significant employment losses (gains) in both the short and long run. This result aligns with the literature suggesting that STW employment gains are primarily driven by productive firms that unexpectedly adopted STW in response to sudden shocks, such as economic closures. Future research will explore the degree of deadweight effects and heterogeneous responses across firms and worker characteristics, particularly in sectors less affected by these closures. </font>
</p> 
