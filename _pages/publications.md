...
<p style="text-align: justify"> <font size="-1"> <strong> Abstract: </strong>  We evaluate the effectiveness of Belgium’s short-time work (STW) program during the Great Recession, a period when the country experienced Europe’s highest STW uptake. STW, which allows firms to reduce working hours in response to temporary economic shocks, plays a crucial role in European social insurance systems. Using an instrumental variable approach that leverages quasi-exogeneous variation from an institutional feature of the program in Belgium, we find that, although STW does not significantly increase employment for the average firm, it does enhance firm survival one year later, likely due to delayed bankruptcies. Notably, smaller firms exhibit a positive employment effect post-treatment, suggesting that STW stabilizes employment where liquidity constraints are more binding. </font>
</p> 
