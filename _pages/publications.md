...
<p style="text-align: justify"> <font size="-1"> <strong> Abstract: </strong> Short-Time Work (STW) programs aim to protect jobs and firms, but their effectiveness during the pandemic remains insufficiently understood from a causal perspective. This paper evaluates STW during the COVID-19 pandemic, characterized by widespread economic closures and unprecedented take-up rates. Employing a fuzzy regression discontinuity design, I exploit a unique policy change in Belgium that restricted simplified STW access to firms that did not use the program for at least 20% of total contractual days at the crisis peak and to workers outside the “most-affected” joint committees. The results show that, locally, STW was, on average, more effective at preserving jobs for eligible workers in firms with at least one most-affected joint committee, both in the short and long run. In contrast, firms employing only workers outside these committees experienced no significant impact on headcount employment. These heterogeneous effects align with STW theory, suggesting the program is more effective for firms with stronger pre-crisis performance indicators that faced unexpected shocks, though the existence of negative selection within this group cannot be ruled out. Future research will explore the extent of deadweight effects and further heterogeneity within these groups. </font>
</p> 
...
<p style="text-align: justify"> <font size="-1"> <strong> Abstract: </strong>  We examine the effectiveness of Short-time Work (STW) programs during the Great Recession (GR) in Belgium, which had the highest uptake of STW in Europe. Designed to preserve job matches by allowing reductions in working hours in response to temporary economic shocks, STW is a key component of social insurance systems across Europe. While previous studies have explored the program’s impact in other European countries using firm-level data, their conclusions vary based on the characteristics of treated firms and the persistence of economic shocks. Our study adopts an econometric approach with grouped data, leveraging exogenous variations in STW take-up due to an institutional feature. In line with existing literature, we find that STW take-up reduces working hours per employee while preserving jobs, but only for small firms that are more vulnerable to financial shocks and liquidity constraints. However, deadweight losses arise from the untargeted protection of unviable jobs in larger firms. </font>
</p> 
...
<p style="text-align: justify"> <font size="-1"> <strong> Abstract: </strong> This paper evaluates a hiring subsidy for lower-educated youth  in Flanders (Belgium) that reduced labour costs by approximately 13\% for a period of two years. Using a regression discontinuity design, we find no evidence that the subsidy improved the job finding rate of eligible job seekers in 2016-19, a period marked by a tight labour market. We then investigate the role of temporary work agencies, which obtain 25\% to 34\% of the subsidies. Using difference-in-differences regressions, we demonstrate that agencies did not raise wages of eligible agency workers in response to the policy. Remarkably, despite a 3.3\% labour cost reduction, full-time equivalent employment of eligible workers in these agencies decreased by 9\% after the reform. Our findings highlight the role of temporary work agencies in shaping the effectiveness of a hiring subsidy.  </font>
</p> 
